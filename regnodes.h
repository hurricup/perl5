...
#define	OPFAIL                	84	/* 0x54 Same as (?!), but with verb arg */
#define	ACCEPT                	85	/* 0x55 Accepts the current matched string, with verbar */
...
#else
EXTCONST U8 PL_varies_bitmask[] = {
    0x00, 0x00, 0x00, 0x80, 0x01, 0xF0, 0xE7, 0x7F, 0x19, 0x00, 0x00, 0x00
};
#endif /* DOINIT */
